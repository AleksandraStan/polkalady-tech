...
export const articles: BlogArticle[] = [
  {
    ...
    sections: [
      ...
      {
        heading: "A detective story made of coordinates",
        paragraphs: [
      ...
      {
        heading: "What the model had to rebuild",
        paragraphs: [
      ...
      {
        heading: "From map matching to general-purpose LLMs",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Repository: https://github.com/AleksandraStan/polkalady-tech",
        ],
      },
    ],
  },
